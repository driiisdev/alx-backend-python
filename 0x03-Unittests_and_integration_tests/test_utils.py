...
class TestGetJson(TestCase):
    ...
    def test_payload(self, test_url: str, test_payload: Dict) -> None:
        """ Test for `get_json` """
        with patch('requests.get', return_value=mock.Mock(json=mock.Mock(return_value=test_payload))) as mock_get:
